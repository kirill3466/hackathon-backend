...
@router.get("/audio/{employee_id}", response_model=list[ResultRead])
...
@router.get("/video/{employee_id}", response_model=list[ResultRead])
...
@router.get("/test/{employee_id}", response_model=list[ResultRead])
