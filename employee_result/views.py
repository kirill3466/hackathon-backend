...
@router.get("/employee/{employee_id}", response_model=list[ResultRead])
...
@router.get("/employee/{employee_id}/audio", response_model=list[ResultRead])
...
@router.get("/employee/{employee_id}/video", response_model=list[ResultRead])
...
@router.get("/employee/{employee_id}/test", response_model=list[ResultRead])
